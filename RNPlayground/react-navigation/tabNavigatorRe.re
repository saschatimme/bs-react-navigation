...
module Component = {
  type navigationOptionsRecord = {
    ...
    /*
     tabBarIcon: option (focused::bool => tintColor::string => ReasonReact.reactElement),
     tabBarLabel: option (focused::bool => tintColor::string => ReasonReact.reactElement)*/
  };
...
type navigationOptions =
  Js.t {
    ...
    tabBarIcon :
      Js.Undefined.t (Js.t {. focused : Js.boolean, tintColor : string} => ReasonReact.reactElement),
    tabBarLabel :
      Js.Undefined.t (Js.t {. focused : Js.boolean, tintColor : string} => ReasonReact.reactElement)
  };

type tabBarElement = [
  | `static ReasonReact.reactElement
  | `dynamic (focused::bool => tintColor::string => ReasonReact.reactElement)
];
...
type routeConfig 'screenProps =
  Js.t {
    .
    screen : screenBagJs 'screenProps => ReasonReact.reactElement,
...
let routeConfig
    screen::(screen: Component.screenBag 'screenProps => ReasonReact.reactElement)
